<template>
  <div>
                ...
                <div id="rev_slider_1078_1" class="rev_slider fullwidthabanner" data-version="5.4.1">
                    <ul>	<!-- SLIDE  -->
                        <li data-index="rs-3045" data-transition="boxfade" data-slotamount="default"
                            ...
                            <!-- MAIN IMAGE -->
                            <img src="images/home-screen.jpg"  alt=""  data-bgposition="center center"
                                 data-bgfit="cover"
                            ...
                            <!-- <div class="tp-caption tp-resizeme"
                                ...
                                <h3 class="slidetop__title">we make difference</h3>
                            </div> --> <!-- end tp-caption -->
                            ...
                            <!-- <div class="tp-caption tp-resizeme"
                                 ...
                                 data-hoffset="-60"
                                 data-y="['center','center','center','center']"
                                 data-voffset="['-6','-6','-6','5']"
                                 data-fontsize="['90','90','70','70']"
                                 data-lineheight="['82', '82', '72', '72']"
                                 data-width="none"
                                 data-height="none"
                                 data-whitespace="nowrap"
                                 data-type="text"
                            ...
                            <!-- <div class="tp-caption tp-resizeme"
                                 ...
                                 data-voffset="['260','260','220','155']"
                                 data-width="none"
                                 data-height="none"
                                 data-whitespace="nowrap"
                                 data-type="text"
                                 data-responsive_offset="on"
                                 data-frames='[{"delay":3020,"speed":1900,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
                                 data-textAlign="['left','left','left','left']"
                                 data-paddingtop="[0,0,0,0]"
                                 data-paddingright="[0,0,0,0]"
                                 data-paddingbottom="[0,0,0,0]"
                            ...
                            <div class="rotate-text-wrap rotate-text-wrap-two">
                                <div class="rotate-text">
                        ...
                        <!-- <li data-index="rs-3046" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            ...
                            <!-- MAIN IMAGE -->
                            <!-- <img src="images/slider_bg2.jpg"  alt=""  data-bgposition="center center" -->
                            <!-- <img src="images/home-screen.jpg"  alt=""  data-bgposition="center center" -->
                            <!-- <img src="images/home-screen.jpg"  alt=""  data-bgposition="center center" 
                                 data-bgfit="cover"
                                 data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina> -->
                            ...
                            <!-- <div class="tp-caption tp-resizeme rs-parallaxlevel-1"
                                 ...
                                 data-type="text"
                                 data-responsive_offset="on"
                                 data-frames='[{"from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","speed":2000,"to":"o:1;","delay":3020,"ease":"Power4.easeInOut"},{"delay":"wait","speed":1000,"to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]'
                                 data-textAlign="['left','left','left','left']"
                                 data-paddingtop="[0,0,0,0]"
                                 data-paddingright="[0,0,0,0]"
                                 data-paddingbottom="[0,0,0,0]"
    ...
    <!-- <section class="slider-one">
      <div class="slider-one__carousel">
        <swiper :options="swiperOptions">
          <swiper-slide>
            <div
              class="item slider-one__slider-1"
              style="background-image: url(/images/home-gereja1.jpg)"
            >
              <div
                class="container slider__content"
    ...
    <section
      ...
      class="offer-area responsive-content inspire-area area-padding"
    >
              ...
              <div class="offer-list">
                <div class="avivon-heading">
                  <h2 class="avivon__title inspire-title">
                    Tentang Gereja St. Fransiskus Xaverius Naimata <br />
                  </h2>
...
<section class="choose-area area-padding text-center">
    ...
    style="background-image: url(/images/gereja1.jpg)">
              ...
              <div class="trusted-content">
                <div class="trusted__title mb-60px">
                  <h2 class="trusted__title-title">
                    Gereja Stasi St. Fransiskus Xaverius Naimata
                  </h2>
                </div>
                <!-- end trusted__title -->
              </div>
